...
- The JSON body of the `/sign_tx` endpoint has an additional field `auxilary_data`, which, like `message` (previously `preimage`) is a hex-encoded `string`. [#475](https://github.com/entropyxyz/entropy-core/pull/475/)
