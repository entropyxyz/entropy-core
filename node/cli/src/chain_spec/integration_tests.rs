...
pub fn integration_tests_genesis_config(
    ...
    serde_json::json!( {
        ...
        "stakingExtension": StakingExtensionConfig {
            ...
            mock_signer_rotate: (true, mock_signer_rotate_data, vec![get_account_id_from_seed::<sr25519::Public>("Charlie//stash")], vec![get_account_id_from_seed::<sr25519::Public>("Bob//stash"), get_account_id_from_seed::<sr25519::Public>("Dave//stash")]),
        },
