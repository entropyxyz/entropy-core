...
async fn create_verify_signed_message() {
    ...
    let _err = Box::new(SigningErr::MessageValidation("Unable to verify sender of message".to_string()));
    ...
    let _err_2 = Box::new(SigningErr::MessageValidation("Unable to verify origins of message".to_string()));
