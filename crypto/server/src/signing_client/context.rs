...
impl Context {
  ...
  pub(crate) fn new(
    ...
    let sign_parties =
      Self::get_sign_parties(party_info.tofnd.party_uids.len(), &sign_init.participant_indices)?;
  ...
  pub(crate) fn group(&self) -> &GroupPublicInfo { &self.party_info.common }
  ...
  pub(crate) fn msg_to_sign(&self) -> &MessageDigest { &self.sign_init.message_to_sign }
