...
fn test_acl_functions_properly() {
    ...
    assert!(allowlisted_acl.eval(to_address_1_tx.clone()).is_ok());

    assert!(allowlisted_acl.eval(to_address_2_tx.clone()).is_err());
    assert!(allowlisted_acl.eval(to_address_3_tx.clone()).is_err());
    ...
    assert!(denylisted_acl.eval(to_address_2_tx.clone()).is_ok());
    assert!(denylisted_acl.eval(to_address_3_tx.clone()).is_ok());
    ...
    assert!(allowlisted_acl_with_null_recipient.eval(to_address_1_tx.clone()).is_ok());
    assert!(allowlisted_acl_with_null_recipient.eval(to_null_recipient_tx.clone()).is_ok());

    assert!(allowlisted_acl_with_null_recipient.eval(to_address_2_tx.clone()).is_err());
    ...
    assert!(denylisted_acl_with_null_recipient.eval(to_address_2_tx.clone()).is_ok());
    assert!(denylisted_acl_with_null_recipient.eval(to_address_3_tx.clone()).is_ok());
    assert!(denylisted_acl_with_null_recipient.eval(to_null_recipient_tx.clone()).is_ok());
    ...
    // should fail all txs
    assert!(empty_acl.eval(to_address_1_tx).is_err());
    assert!(empty_acl.eval(to_address_2_tx).is_err());
    assert!(empty_acl.eval(to_address_3_tx).is_err());
