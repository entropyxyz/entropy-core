...
// pub async fn sm_manager_cli() -> Result<(), Box<dyn std::error::Error>> {
pub async fn sm_manager_cli() -> Result<()> {
	let figment = rocket::Config::figment()
		.merge(("limits", rocket::data::Limits::new().limit("string", 100.megabytes())));
