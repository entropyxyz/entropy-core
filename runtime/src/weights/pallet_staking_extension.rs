...
impl<T: frame_system::Config> pallet_staking_extension::WeightInfo for WeightInfo<T> {
	...
	fn new_session_handler_helper(c: u32, n: u32, ) -> Weight {
		...
		Weight::from_ref_time(50_000_000 as u64)
			// Standard Error: 370_095
			.saturating_add(Weight::from_ref_time(1_339_810 as u64).saturating_mul(c as u64))
			// Standard Error: 370_095
			.saturating_add(Weight::from_ref_time(1_378_277 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}
