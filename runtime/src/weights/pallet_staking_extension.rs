...
impl<T: frame_system::Config> pallet_staking_extension::WeightInfo for WeightInfo<T> {
	...
	fn new_session_handler_helper(c: u32, n: u32, ) -> Weight {
		...
		Weight::from_parts(18_000_000, 0)
			...
			// Standard Error: 188_473
			.saturating_add(Weight::from_parts(696_979, 0).saturating_mul(c.into()))
			// Standard Error: 188_473
			.saturating_add(Weight::from_parts(714_779, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
