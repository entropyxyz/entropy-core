...
//! DATE: 2024-09-27, STEPS: `5`, REPEAT: `2`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> pallet_staking_extension::WeightInfo for WeightInfo<T> {
	...
	fn change_threshold_accounts() -> Weight {
		...
		Weight::from_parts(41_000_000, 0)
			.saturating_add(Weight::from_parts(0, 4907))
	...
	fn confirm_key_reshare_confirmed(c: u32, ) -> Weight {
		...
		Weight::from_parts(22_732_044, 0)
	...
	fn new_session_base_weight(s: u32, ) -> Weight {
		...
		Weight::from_parts(7_998_054, 0)
			.saturating_add(Weight::from_parts(0, 1751))
			// Standard Error: 63_313
			.saturating_add(Weight::from_parts(85_603, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn new_session(c: u32, _l: u32, ) -> Weight {
		...
		// Minimum execution time: 19_000_000 picoseconds.
		Weight::from_parts(24_550_626, 0)
			.saturating_add(Weight::from_parts(0, 1978))
			// Standard Error: 154_701
			.saturating_add(Weight::from_parts(24_569, 0).saturating_mul(c.into()))
