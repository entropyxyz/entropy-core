...
impl<T: frame_system::Config> pallet_relayer::WeightInfo for WeightInfo<T> {
	...
	fn prep_transaction(s: u32, ) -> Weight {
		...
		Weight::from_ref_time(429_648_806 as u64)
			// Standard Error: 46_335
			.saturating_add(Weight::from_ref_time(6_648_137 as u64).saturating_mul(s as u64))
	...
	fn register(a: u32, _b: u32, ) -> Weight {
		// Minimum execution time: 36_000 nanoseconds.
		Weight::from_ref_time(39_051_585 as u64)
			// Standard Error: 10_475
			.saturating_add(Weight::from_ref_time(24_493 as u64).saturating_mul(a as u64))
	...
	fn confirm_register_registering(_c: u32, ) -> Weight {
		...
		Weight::from_ref_time(64_250_828 as u64)
	...
	fn confirm_register_registered(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(68_969_889 as u64)
			// Standard Error: 95_286
			.saturating_add(Weight::from_ref_time(288_674 as u64).saturating_mul(c as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
	...
	fn confirm_register_swapping(_c: u32, ) -> Weight {
		...
		Weight::from_ref_time(66_374_309 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
}
