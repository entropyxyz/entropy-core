...
//! DATE: 2023-04-13, STEPS: `5`, REPEAT: 2, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> pallet_relayer::WeightInfo for WeightInfo<T> {
	...
	fn prep_transaction(s: u32, ) -> Weight {
		// Minimum execution time: 175_000 nanoseconds.
		Weight::from_ref_time(518_700_000 as u64)
			// Standard Error: 652_653
			.saturating_add(Weight::from_ref_time(7_713_600 as u64).saturating_mul(s as u64))
	...
	fn register(_a: u32, b: u32, ) -> Weight {
		...
		Weight::from_ref_time(52_519_856 as u64)
			// Standard Error: 272_238
			.saturating_add(Weight::from_ref_time(151_447 as u64).saturating_mul(b as u64))
