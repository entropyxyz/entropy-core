...
impl<T: frame_system::Config> pallet_relayer::WeightInfo for WeightInfo<T> {
	...
	fn register(p: u32, ) -> Weight {
		...
		Weight::from_parts(36_951_601, 0)
			.saturating_add(Weight::from_parts(0, 3598))
			// Standard Error: 1
			.saturating_add(Weight::from_parts(619, 0).saturating_mul(p.into()))
	...
	fn confirm_register_registering(c: u32, ) -> Weight {
		...
		Weight::from_parts(36_883_701, 0)
			.saturating_add(Weight::from_parts(0, 19963))
			// Standard Error: 317_856
			.saturating_add(Weight::from_parts(10_104_419, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `StakingExtension::ThresholdToStash` (r:1 w:0)
	...
	fn confirm_register_failed_registering(_c: u32, ) -> Weight {
		...
		Weight::from_parts(40_486_464, 0)
	...
	fn confirm_register_registered(_c: u32, ) -> Weight {
		...
		Weight::from_parts(47_220_441, 0)
