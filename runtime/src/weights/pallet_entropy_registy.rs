...
// --pallet=pallet_entropy_registry
// --extrinsic=*
// --steps=50
// --repeat=20
...
/// Weight functions for `pallet_entropy_registry`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pallet_entropy_registry::WeightInfo for WeightInfo<T> {
