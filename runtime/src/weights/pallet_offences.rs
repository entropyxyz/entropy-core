...
impl<T: frame_system::Config> pallet_offences::WeightInfo for WeightInfo<T> {
	...
	fn report_offence_grandpa(n: u32, ) -> Weight {
		...
		Weight::from_parts(131_088_516, 0)
			.saturating_add(Weight::from_parts(0, 8149))
			// Standard Error: 23_224
			.saturating_add(Weight::from_parts(15_737_753, 0).saturating_mul(n.into()))
	...
	fn report_offence_babe(n: u32, ) -> Weight {
		...
		//  Measured:  `1848 + n * (66 ±0)`
		//  Estimated: `8149 + n * (2551 ±0)`
		// Minimum execution time: 120_623_000 picoseconds.
		Weight::from_parts(130_123_615, 0)
			.saturating_add(Weight::from_parts(0, 8149))
			// Standard Error: 21_233
			.saturating_add(Weight::from_parts(15_804_597, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(19))
			.saturating_add(T::DbWeight::get().reads((3_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(13))
			.saturating_add(T::DbWeight::get().writes((3_u64).saturating_mul(n.into())))
