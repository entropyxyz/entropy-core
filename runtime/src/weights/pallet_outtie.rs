...
//! Autogenerated weights for `pallet_outtie`
//!
//! THIS FILE WAS AUTO-GENERATED USING THE SUBSTRATE BENCHMARK CLI VERSION 43.0.0
//! DATE: 2025-05-05, STEPS: `5`, REPEAT: `2`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
/// Weight functions for `pallet_outtie`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pallet_outtie::WeightInfo for WeightInfo<T> {
