...
impl<T: frame_system::Config> pallet_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		//  Measured:  `105`
		//  Estimated: `38351`
		// Minimum execution time: 82_486_000 picoseconds.
		Weight::from_parts(83_886_000, 0)
			.saturating_add(Weight::from_parts(0, 38351))
			// Standard Error: 18
			.saturating_add(Weight::from_parts(7_287, 0).saturating_mul(l.into()))
	...
	fn renew() -> Weight {
		...
		//  Measured:  `293`
		//  Estimated: `40351`
		// Minimum execution time: 105_768_000 picoseconds.
		Weight::from_parts(109_556_000, 0)
	...
	fn check_proof_max() -> Weight {
		...
		//  Measured:  `37074`
		//  Estimated: `40351`
		// Minimum execution time: 82_951_000 picoseconds.
		Weight::from_parts(84_052_000, 0)
			.saturating_add(Weight::from_parts(0, 40351))
			.saturating_add(T::DbWeight::get().reads(5))
