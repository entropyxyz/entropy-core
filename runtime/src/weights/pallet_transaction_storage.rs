...
impl<T: frame_system::Config> pallet_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		//  Measured:  `225`
		//  Estimated: `38351`
		// Minimum execution time: 77_777_000 picoseconds.
		Weight::from_parts(78_658_000, 0)
			.saturating_add(Weight::from_parts(0, 38351))
			// Standard Error: 11
			.saturating_add(Weight::from_parts(7_956, 0).saturating_mul(l.into()))
	...
	fn renew() -> Weight {
		...
		Weight::from_parts(107_501_000, 0)
