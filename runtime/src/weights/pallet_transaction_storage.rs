...
impl<T: frame_system::Config> pallet_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(114_146_000, 0)
			.saturating_add(Weight::from_parts(0, 38351))
			// Standard Error: 8
			.saturating_add(Weight::from_parts(7_953, 0).saturating_mul(l.into()))
	...
	fn renew() -> Weight {
		...
		//  Measured:  `293`
		//  Estimated: `40351`
		// Minimum execution time: 130_832_000 picoseconds.
		Weight::from_parts(133_566_000, 0)
	...
	fn check_proof_max() -> Weight {
		...
		Weight::from_parts(100_314_000, 0)
			.saturating_add(Weight::from_parts(0, 40351))
			.saturating_add(T::DbWeight::get().reads(5))
