...
impl<T: frame_system::Config> pallet_transaction_storage::WeightInfo for WeightInfo<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		//  Measured:  `105`
		//  Estimated: `38351`
		// Minimum execution time: 86_335_000 picoseconds.
		Weight::from_parts(87_464_000, 0)
			.saturating_add(Weight::from_parts(0, 38351))
			// Standard Error: 7
			.saturating_add(Weight::from_parts(7_519, 0).saturating_mul(l.into()))
	...
	fn renew() -> Weight {
		...
		//  Measured:  `293`
		//  Estimated: `40351`
		// Minimum execution time: 111_358_000 picoseconds.
		Weight::from_parts(114_958_000, 0)
	...
	fn check_proof_max() -> Weight {
		...
		Weight::from_parts(88_829_000, 0)
			.saturating_add(Weight::from_parts(0, 40351))
			.saturating_add(T::DbWeight::get().reads(5))
