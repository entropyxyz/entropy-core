...
pub mod pallet {
  use frame_support::{
    dispatch::DispatchResult, inherent::Vec, pallet_prelude::*, traits::IsSubType, weights::Pays,
  };
  ...
  pub type Registered<T: Config> = StorageMap<_, Blake2_128Concat, T::AccountId, bool, ValueQuery>;
